 ...
 */
final class Version20220601160933 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE status (id INT AUTO_INCREMENT NOT NULL, depot_id INT NOT NULL, article_id INT DEFAULT NULL, unit_id INT NOT NULL, code VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, value VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, vat DOUBLE PRECISION NOT NULL, price DOUBLE PRECISION NOT NULL, file VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, INDEX IDX_7B00651C7294869C (article_id), INDEX IDX_7B00651CF8BD700D (unit_id), INDEX IDX_7B00651C8510D4DE (depot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
