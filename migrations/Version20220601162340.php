 ...
 */
final class Version20220601162340 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE status (id INT AUTO_INCREMENT NOT NULL, depot_id INT NOT NULL, article_id INT NOT NULL, unit_id INT NOT NULL, code VARCHAR(255) DEFAULT NULL, value DOUBLE PRECISION NOT NULL, vat DOUBLE PRECISION DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, file VARCHAR(255) DEFAULT NULL, INDEX IDX_7B00651C8510D4DE (depot_id), INDEX IDX_7B00651C7294869C (article_id), INDEX IDX_7B00651CF8BD700D (unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
