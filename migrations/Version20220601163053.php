 ...
 */
final class Version20220601163053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_to_depot_depots (user_to_depot_id INT NOT NULL, depots_id INT NOT NULL, INDEX IDX_5703AC6CE15283E5 (user_to_depot_id), INDEX IDX_5703AC6C869F5222 (depots_id), PRIMARY KEY(user_to_depot_id, depots_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
